...
export const menuData: MenuItem[] = [
  ...
  {
    id: 'a1000000-0000-0000-0000-000000000005-goiaba',
    name: 'Suco de Goiaba',
    description: 'Polpa de goiaba fresca batida com água gelada. Refrescante e nutritiva.',
    price: 12.00,
    image_url: '/img/sucogoiaba.jpg',
    category: 'Bebidas',
    featured: false,
    available: true,
    tags: ['natural, regional']
